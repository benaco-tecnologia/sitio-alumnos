		  ...
		  <tr>
			...
			<% CargarTop1()%><% SubMenu()%>
			 <table width="762" border="0" cellspacing="15" cellpadding="0">
				  <tr> 
					<td width="436"><img src="Imagenes/T-rev_secciones_horarios.gif" width="400" height="38"></td>
					<td width="281">&nbsp;</td>
				  </tr>
				  <%
				  ...
				  if BCL_ADO(StrSql, rst) then
				   ...
				   StrSql = StrSql & " And  d.codcli='" & Session("codcli") & "' "
				   StrSql = StrSql & " And  f.tipo = 'OPTATIVO ESPECIAL'"
				   StrSql = StrSql & " And  o.tipo = 'OPTATIVO ESPECIAL' and  d.codcli=''"
			  ...
			  if CantidadRamos > 1 then
					...
					%>
						  <tr> 
									...
									<td height="40"> 
									  <div align="right"><a href="inscrip-asigna.asp" onMouseOut="MM_swapImgRestore();" onMouseOver="MM_swapImage('continuar-on','','imagenes/continuar-on.gif',1);"></a>									  </div>
						...
						<%
						 ...
						 %>
							...
							<td> 
							  <div align="right">
							  <a href="inscrip-asigna.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','Imagenes/continuar-on.gif',1)"><img src="Imagenes/continuar-of.gif" width="83" height="21" name="Image1" border="0"></a></div>							</td>
							</tr>
					 <%  
						   end if
			else
				%>
						<td height="21"> 
						  <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b><font size="1"><!--a href="javascript:;" onMouseOver="MM_openBrWindow('tex-seccionhorario.htm','seccionhorario','width=500,height=500')"><img src="imag/botones/instrucciones.gif" width="122" height="23" border="0"></a--></font></b></font></p>						</td>
						<td> 
						  <div align="right"><a href="inscrip-asigna.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','Imagenes/continuar-on.gif',1)"><img src="Imagenes/continuar-of.gif" width="83" height="21" name="Image1" border="0"></a>						  </div>						</td>
					</tr>
				  <%          
			end if  
			%>
					 ...
					 select Case TipoRamo
					   case ""'otros ramos
						...
						case "OBLIGATORIO"
								 ...
								 if EsPlanificado(RamosSelec(i), CodSede, Ano, Periodo, CodCarr) then
			...
			%>
				  ...
				  <td colspan="2" height="83"><table width="750" cellspacing="1" cellpadding="0" height="106" border="0" bordercolor="#FFFFFF">
					  <tr bgcolor="83a3d0"> 
						<td height="22" colspan="9" background="Imagenes/fdo-cabecera-cel.jpg"> <div align="left"><font face="Verdana, Arial, Helvetica, sans-serif"><b><font size="2">Asignatura: 
							<% if TipoRamo<>"" then
					  ...
					  <tr background="Imagenes/fdo-cabecera-cel22.jpg" height="30"> 
						<td width="38" height="30" background="Imagenes/fdo-cabecera-cel22.jpg"> <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b><font size="1">Lista 
						Curso</font></b></font></div></td>
						<td width="111" height="30" background="Imagenes/fdo-cabecera-cel22.jpg"> <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b><font size="1">Profesor</font></b></font></div></td>
						<td width="89" height="30" background="Imagenes/fdo-cabecera-cel22.jpg"> <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b><font size="1">S</font><font size="1">ecci&oacute;n</font></b></font></div></td>
						<td width="98" height="30" background="Imagenes/fdo-cabecera-cel22.jpg"> <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b><font size="1">Horario</font></b></font></div></td>
						<td width="140" height="30" background="Imagenes/fdo-cabecera-cel22.jpg"> <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b><font size="1">Ramo</font></b></font></div></td>
						...
						<td width="44" height="30" background="Imagenes/fdo-cabecera-cel22.jpg"> <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b><font size="1">Inscribir</font></b></font></div></td>
						<td width="96" height="30" background="Imagenes/fdo-cabecera-cel22.jpg"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b><font size="1">Tipo 
						  Asignatura </font></b></font> </td>
						<td width="90" height="30" background="Imagenes/fdo-cabecera-cel22.jpg"><div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b><font size="1"></font></b></font></div></td>
					  </tr>
					  <%             
									 x=0
									 do while posRamos <= Ubound(ArrayRamos, 2) and TipoCurso="T" 'and x=0
											 ...
											 TipoCupo = "CT"
												 ...
												 End Select
													  %>
					  <tr bgcolor="#DBECF2"> 
						<td width="38" height="20" align="center" bgcolor="#DBECF2"> <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="detalle-asignatura.asp?R=<%=ArrayRamos(0, posRamos)%>&S=<%=ArrayRamos(1, posRamos)%> " target="_blank"><%=ArrayRamos(0, posRamos)%></a></font></div></td>
						<td width="111" height="16" align="center"> <div align="center"><font face="Verdana" size="1"><%=ArrayRamos(5, posRamos) + " " + ArrayRamos(6, posRamos)%></font></div></td>
						<td width="89" height="16" align="center" bgcolor="#DBECF2"> <div align="center"><font face="Verdana" size="1"><%=ArrayRamos(1, posRamos)%></font></div></td>
						<td width="98" height="16" align="center"> <div align="center"><font face="Verdana" size="1"><%=ArrayRamos(7, posRamos)%></font></div></td>
						<td width="140" height="16" align="center"> <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"></font><font face="Verdana" size="0"><%=ArrayRamos(2, posRamos)%></font></div></td>
						...
						<td width="44" height="16" > <div align="center">
						...
						<td width="96" ><center> <p><font face="Verdana" size="1"><%=TextoTipoCurso%></font><font face="Verdana" size="1"></font></p></center></td>
						<td width="90" valign="top"> <p><font face="Verdana" size="1"></font><font face="Verdana" size="1"></font></p></td>
					  </tr>
					  <%		posRamos = posRamos + 1
			...
			<tr valign="top"> 
			  <td width="707" height="83" colspan="2"> 
				  <table width="750" cellspacing="0" cellpadding="0" height="106" border="1" bordercolor="#FFFFFF">
					  <tr bgcolor="83a3d0"> 
								<td height="22" colspan="9"> <div align="left"><font face="Verdana, Arial, Helvetica, sans-serif"><b><font size="2">Asignatura: 
									<% if TipoRamo<>"" then
											response.Write(RamosSelec(i) + " " + GetNombreRamo(RamosSelec(i)))
										else
											response.Write(RamosSelec(i) & " " & replace(GetNombreRamo(RamosSelec(i)),"FORMACION GENERAL","CURSO OPTATIVO ADICIONAL"))
										end if%></font></b></font></div>
								</td>
					  </tr>
					  <tr background="Imagenes/fdo-cabecera-cel22.jpg"> 
								<td width="37" height="30" background="Imagenes/fdo-cabecera-cel22.jpg" >
									   <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b><font size="1">Lista Curso</font></b></font></div>
						</td>
								<td width="105" height="30" background="Imagenes/fdo-cabecera-cel22.jpg"> 
									   <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b><font size="1">Profesor</font></b></font></div>
						</td>
								<td width="79" height="30" background="Imagenes/fdo-cabecera-cel22.jpg">
								...
								<td width="93" height="30" background="Imagenes/fdo-cabecera-cel22.jpg">
						...
						<td width="94" height="30" background="Imagenes/fdo-cabecera-cel22.jpg"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif" >
						  <center>
							<b>Corresponde Seccion Teorica N° </b>
			</center></font> </td>
					  </tr>
			  <% 	x=0
							  ...
							  Inscritos = CantidadInscritosOptativos(RamosSelec(i), ArrayRamos(0, posRamos), ArrayRamos(1, posRamos), CodSede, Ano, Periodo, CodCarr, TipoCupo, TipoCurso) 							  	  	
							   ...
							   <tr bgcolor="#DBECF2"> 
												<td width="37" height="20" align="center">
													   <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><a href="detalle-asignatura.asp?R=<%=ArrayRamos(0, posRamos)%>&S=<%=ArrayRamos(1, posRamos)%> " target="_blank"><%=ArrayRamos(0, posRamos)%></a></font></div>
								 </td>
												<td width="105" height="20" align="center"> 
													   <div align="center"><font face="Verdana" size="1"><%=ArrayRamos(5, posRamos) + " " + ArrayRamos(6, posRamos)%></font></div>
								 </td>
												...
												<td width="93" height="20" align="center">
													   <div align="center"><font face="Verdana" size="1"><%=ArrayRamos(7, posRamos)%></font></div>
								 </td>
												<td width="130" height="20" align="center">
													   <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"></font><font face="Verdana" size="0"><%=ArrayRamos(2, posRamos)%></font></div>
								 </td>
											...
											<td width="75" height="20" >
											 <div align="center"><font face="Verdana" size="1"><%=TextoTipoCurso %></font></div>
											 
													 
								 </td>
											
											<td width="94" height="20" >
													 <p><font face="Verdana" size="1" color="#000000" ><center><%=ArrayRamos(9, posRamos)%></center></font><font face="Verdana" size="1"></font></p>
								 </td>
				...
				<table width="750" border="0" cellspacing="15" cellpadding="0">
					<tr valign="top"> 
					  <td colspan="2" height="83"> 
						  <table width="750" cellspacing="1" cellpadding="0" height="55" border="0" bordercolor="#FFFFFF">
					  <tr bgcolor="83a3d0"> 
										<td height="22" colspan="9"> <div align="left"><font face="Verdana, Arial, Helvetica, sans-serif"><b><font size="2">Asignatura: 
											<% if TipoRamo<>"" then
													response.Write(RamosSelec(i) + " " + GetNombreRamo(RamosSelec(i)))
								...
								<tr background="Imagenes/fdo-cabecera-cel22.jpg"> 
										...
										<td width="136" height="30" background="Imagenes/fdo-cabecera-cel22.jpg"> 
										...
										<td width="40" height="30" background="Imagenes/fdo-cabecera-cel22.jpg">
												<div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b><font size="1">S</font><font size="1">ecci&oacute;n</font></b></font></div>					  </td>
										<td width="96" height="30" background="Imagenes/fdo-cabecera-cel22.jpg">
										...
										<td width="30" height="30" background="Imagenes/fdo-cabecera-cel22.jpg">
												 <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b><font size="1"> 
													Cupo</font></b></font></div>					  </td>
										<td width="45" height="30" background="Imagenes/fdo-cabecera-cel22.jpg"> 
												  <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b><font size="1">Inscribir</font></b></font></div>					  </td>
										<td width="75" height="30"background="Imagenes/fdo-cabecera-cel22.jpg"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b><font size="1">Tipo 
												  Asignatura </font></b></font>						    </td>
										 <td width="88" height="30"background="Imagenes/fdo-cabecera-cel22.jpg"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif" >
								  <center><b>Corresponde Seccion Teorica N° </b></center></font> </td>
							</tr>
							  <%             
								 X=0 
