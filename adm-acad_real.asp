...
<body background="ima/iso-uhc.gif" onLoad="MM_preloadImages('imag/botones/salir-on.gif','imag/f-der/ficha-on.gif','imag/f-der/concentracion-on.gif','imag/f-der/encuesta-on.gif','imag/f-der/inscripcion-on.gif','ImagenBoton/actualiza-on.gif')">
    ...
    <tr valign="top"> 
      <td height="21"> <table width="584" border="0" cellspacing="0" cellpadding="0" height="108">
          <tr> 
            ...
            <%end if%>
			<%else%>
	            <td width="133"><a href="MensajeBloqueoHabilita.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image21','','ImagenBoton/actualiza-on.gif',1)"><img src="ImagenBoton/actualiza-of.gif" name="Image21" width="131" height="20" border="0"></a></td>
			<%end if%>
