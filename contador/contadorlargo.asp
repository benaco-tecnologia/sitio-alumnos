...
<% Dim AntVesp_1, AntVesp_2, AntVesp_3, NueTot_0, NueTot_1, NueTot_2, NueTot_3, AntTot_0, AntTot_1, AntTot_2, AntTot_3, AntTot_4, AntTot_5 %>
...
<table width="649" border="0">
  ...
  <tr> 
    ...
    <td width="61"><div align="center"><font color="#333333" size="1">var %</font></font></div></td>
...
if rst.recordcount > 0 then
   AntTot_4 = CInt(rst("valor"))
		   Response.write(FormatNumber(AntTot_4,0))
else
   response.write "s.i."
end if
...
if rst.recordcount > 0 then
		   Response.write(FormatNumber(CInt(rst("valor")),0))
else
   response.write "s.i."
end if
...
%>
    ...
    <td><div align="center"><font color="#0033FF" size="1" face="Verdana, Arial, Helvetica, sans-serif">
      <% 
	  if ((AntTot_1 + AntTot_2 + AntTot_3 + AntTot_4 + AntTot_5)=0) then
			response.write "s.i."
		else
...
%>
    ...
    <td><div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
      <% 
	    if((AntDiurnos_1 + AntDiurnos_2 + AntDiurnos_3 + AntDiurnos_4 + AntDiurnos_5) = 0) then
			response.write "s.i."
		else
...
%>
    ...
    <td><div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">
      <% 
	  if((AntVesp_1 + AntVesp_2 + AntVesp_3 + AntVesp_4 + AntVesp_5) = 0) then
			response.write "s.i."
		else
  ...
  <tr> 
    ...
    <td width="50"><div align="center"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
        <%
		Response.write(FormatNumber(AntVesp_4+AntDiurnos_4+NueDiurnos_4+NueVesp_4,0))
		%>
		</font></strong></div>
	</td>
    <td width="50"><div align="center"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
      <%
	  response.write (FormatNumber(AntVesp_5+AntDiurnos_5+NueDiurnos_5+NueVesp_5,0))
...
%>
    ...
    <td width="60"><div align="center"><font color="#0033FF" size="2" face="Verdana, Arial, Helvetica, sans-serif">ECAS </font></div></td>
  </tr>
  <tr>
    <td width="150"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Diurnos</font></td>
...
%>
    ...
    <td width="60"><div align="center"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font face="Verdana, Arial, Helvetica, sans-serif"><font size="2"><font color="#000000"></font></font></font> </font></div></td>
  </tr>
  <tr>
    <td width="150"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Vespertinos</font></td>
    <td width="60"><div align="center"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
...
%>
    ...
    <td width="60"><div align="center"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> </font><font color="#000000"></font></div></td>
  </tr>
  <tr>
    <td width="150"><font color="#0033FF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Antiguos</strong></font></td>
    <td width="60"><div align="center"><font color="#0033FF" size="1" face="Verdana, Arial, Helvetica, sans-serif">
