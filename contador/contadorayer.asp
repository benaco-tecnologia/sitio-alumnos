...
rst.open "select count(codcli) as valor from mt_alumno WITH (NOLOCK) where ano_mat=2018 and estacad='VIGENTE' and periodo_mat = 1 and ano =2018 and fec_mat=CONVERT(VARCHAR(11), DATEADD(dd, - 1, GETDATE()))",Conn
if rst.recordcount > 0 then
   response.write rst("valor")
else
   response.write "0"
...
rst.open "select count(codcli) as valor from mt_alumno WITH (NOLOCK) where ano_mat=2018 and estacad='VIGENTE' and periodo_mat = 1 and ano =2018 and jornada='D' and fec_mat=CONVERT(VARCHAR(11), DATEADD(dd, - 1, GETDATE()))",Conn
if rst.recordcount > 0 then
   response.write rst("valor")
else
   response.write "0"
...
rst.open "select count(codcli) as valor from mt_alumno WITH (NOLOCK) where ano_mat=2018 and estacad='VIGENTE' and periodo_mat = 1 and ano =2018 and jornada='V' and fec_mat=CONVERT(VARCHAR(11), DATEADD(dd, - 1, GETDATE()))",Conn
if rst.recordcount > 0 then
   response.write rst("valor")
else
   response.write "0"
...
rst.open "select count(codcli) as valor from mt_alumno WITH (NOLOCK) where ano_mat=2018 and estacad='VIGENTE' and periodo_mat = 1 and fec_mat=CONVERT(VARCHAR(11), DATEADD(dd, - 2, GETDATE()))",Conn
if rst.recordcount > 0 then
   response.write rst("valor")
else
   response.write "0"
