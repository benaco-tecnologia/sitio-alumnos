...
<b>Contador de Toma de Ramos Otono 2018</b> <br>
</font>
<table>
  <tr> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Alumnos Conectados</font> 
    <td><div align="right"></div> 
    <td><div align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><% response.write (application("auxactivos"))%></font></div></td>
  </tr>
  <tr> 
    ...
    <td><div align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
        <% 
           ...
           rst.cursortype = 1
           rst.open "select count ( distinct codcli ) as valor from  sis_reg_inscripcion where fecha >= '20180123' ",Conn
  ...
  <tr> 
    ...
    <td> <div align="right"><font size="2" face="Verdana, Arial"> 
        <%
            set rst = createobject("adodb.recordset")
            rst.cursortype = 1
            rst.open "select count ( distinct codcli ) as valor from  sis_reg_solicitud where fecha >= '20180123' ",Conn
            if rst.recordcount > 0 then
                response.write rst("valor")
            else
               response.write "0"
    ...
    <tr> 
    <td><font size="2" face="Verdana, Arial">Inscritos total:</font> 
    <td><div align="right"></div> 
    <td> <div align="right"><font size="2" face="Verdana, Arial"> 
        <%
            set rst = createobject("adodb.recordset")
            rst.cursortype = 1
            rst.open "select count ( distinct codcli ) as valor from ra_nota where ano='2018' ",Conn
            if rst.recordcount > 0 then
                response.write rst("valor")
            else
               response.write "0"
  ...
  <tr> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Total Alumnos 2017-02</font> 
    <td><div align="right"></div> 
    <td> <div align="right"><font size="2" face="Verdana, Arial"> 
        <%
            set rst = createobject("adodb.recordset")
            rst.cursortype = 1
            rst.open "select count( distinct codcli) as valor from mt_alumno WITH (NOLOCK) where ano_mat=2017 and estacad='VIGENTE' and periodo_mat = 2",Conn
            if rst.recordcount > 0 then
               response.write rst("valor")
            else
               response.write "0"
    ...
    <tr> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Total Alumnos 2018-01</font> 
    <td><div align="right"></div> 
    <td> <div align="right"><font size="2" face="Verdana, Arial"> 
        <%
            set rst = createobject("adodb.recordset")
            rst.cursortype = 1
            rst.open "select count(distinct codcli) as valor from mt_alumno WITH (NOLOCK) where ano_mat=2018 and estacad='VIGENTE' and periodo_mat = 1 and ano <2018 ",Conn
            if rst.recordcount > 0 then
               response.write rst("valor")
            else
               response.write "0"
  ...
  <tr> 
    ...
    <td> <div align="right"><font size="2" face="Verdana, Arial"> 
        <%
            set rst = createobject("adodb.recordset")
            rst.cursortype = 1
            rst.open "select count ( * ) as valor from mt_alumno where ano_ed=2017 and periodo_ed=2 and encdoc='S' ",Conn
            if rst.recordcount > 0 then
               response.write rst("valor")
            else
               response.write "0"
