...
<p> 
<strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Contador Matrícula</font></strong>
</p> 
<table width="541" border="0">
  <tr> 
    ...
    <td width="61"><div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#333333" size="1">var %</font></div></td>
    <td width="44"><div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#333333" size="1">Prom3</font></div></td>
  ...
  <tr> 
    ...
    <td width="50"><div align="center"><font color="#0033FF" size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
		...
		if rst.recordcount > 0 then
		   ...
		   Response.write(FormatNumber( AntTot_0,0))
		else
 		   response.write "0"		 
		end if
...
if rst.recordcount > 0 then
   ...
   Response.write(FormatNumber( AntTot_1,0))
else
   response.write "0"
end if
...
if rst.recordcount > 0 then
   ...
   Response.write(FormatNumber( AntTot_2,0))
else
   response.write "0"
end if
...
%>
    ...
    <td width="50"><div align="center"><font color="#0033FF" size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
		...
		if rst.recordcount > 0 then
		   ...
		   Response.write(FormatNumber( AntTot_3,0))
		else
 		   response.write "s.i."
		end if
		set rst=nothing
...
%>
  ...
  <tr> 
    <td width="150"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b style='mso-bidi-font-weight:normal'>Total Matrícula :</b></font></td>
    <td width="50"><div align="center"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
        <%
		Response.write(FormatNumber( AntVesp_0+AntDiurnos_0+NueDiurnos_0+NueVesp_0, 0))
		%>
        </font></strong></div>
	</td>
    <td width="50"><div align="center"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
        <%
		Response.write(FormatNumber( AntVesp_1+AntDiurnos_1+NueDiurnos_1+NueVesp_1,0))
		%>
        </font></strong></div>
	</td>
    <td width="50"><div align="center"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
        <%
		Response.write(FormatNumber( AntVesp_2+AntDiurnos_2+NueDiurnos_2+NueVesp_2,0))
		%>
        </font></strong></div>
		</td>
    <td width="50"><div align="center"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
        <%
		Response.write(FormatNumber( AntVesp_3+AntDiurnos_3+NueDiurnos_3+NueVesp_3,0))
		%>
        </font></strong></div>
	</td>
...
<p>
<br> 
<strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Contador Diario</font></strong>
</p> 
<table width="541" border="0">
  <tr> 
    <td><strong></strong></td>
...
%>
  ...
  <tr> 
    ...
    <td width="50"><div align="center"><font color="#0033FF" size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
		...
		rst.open "select count(codcli) as valor from mt_alumno WITH (NOLOCK) where ano_mat=2018 and  periodo_mat = 1 and ano <2018 and fec_mat=CONVERT(VARCHAR(11), GETDATE())",Conn
...
rst.open "select count(codcli) as valor from mt_alumno WITH (NOLOCK) where ano_mat=2018 and periodo_mat = 1 and ano <2018 and jornada='D' and fec_mat=CONVERT(VARCHAR(11), GETDATE())",Conn
if rst.recordcount > 0 then
   response.write rst("valor")
else
   response.write "0"
...
rst.open "select count(codcli) as valor from mt_alumno WITH (NOLOCK) where ano_mat=2018 and periodo_mat = 1 and ano <2018 and jornada='V' and fec_mat=CONVERT(VARCHAR(11), GETDATE())",Conn
if rst.recordcount > 0 then
   response.write rst("valor")
else
   response.write "0"
...
%>
  ...
  <tr> 
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b style='mso-bidi-font-weight:normal'>Total Matrícula :</b></font></td>
    <td><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b style='mso-bidi-font-weight:normal'> 
        <%
		set rst = createobject("adodb.recordset")
		rst.cursortype = 1
		
		rst.open "select count(codcli) as valor from mt_alumno WITH (NOLOCK) where ano_mat=2018 and periodo_mat = 1 and fec_mat=CONVERT(VARCHAR(11), GETDATE())",Conn
		if rst.recordcount > 0 then
		response.write rst("valor")
		else
		response.write "0"
...
<p> 
<strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">A&ntilde;o Anterior</font></strong>
</p> 
<table width="541" border="0">
  <tr> 
    <td><strong></strong></td>
    <td width="60"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">2018</font></div></td>
    <td><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">2017</font></div></td>
    <td><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">2016</font></div></td>
    <td><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">2015</font></div></td>
...
rst.open "select count(codcli) as valor from mt_alumno WITH (NOLOCK) where ano_mat=2018 and estacad='VIGENTE' and periodo_mat = 1 and ano =2018",Conn
if rst.recordcount > 0 then
   Response.write(FormatNumber(((nuetot_0 / 421))*100, 2))
else
   var1 = 0
   response.write "0"
end if
...
%>
        % </font></div></td>
    <td width="50"><div align="center"><font color="#0033FF" size="2" face="Verdana, Arial, Helvetica, sans-serif">421</font></div></td>
    <td width="50"><div align="center"><font color="#0033FF" size="2" face="Verdana, Arial, Helvetica, sans-serif">417</font></div></td>
...
rst.open "select count(codcli) as valor from mt_alumno WITH (NOLOCK) where ano_mat=2018 and estacad='VIGENTE' and periodo_mat = 1 and ano =2018",Conn
if rst.recordcount > 0 then
   Response.write(FormatNumber(((nuediurnos_0 / 214))*100, 2))
else
   var1 = 0
   response.write "0"
end if
...
%>
        % </font></div></td>
    <td width="50"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">214</font></div></td>
    <td width="50"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">207</font></div></td>
...
rst.open "select count(codcli) as valor from mt_alumno WITH (NOLOCK) where ano_mat=2018 and estacad='VIGENTE' and periodo_mat = 1 and ano =2018",Conn
if rst.recordcount > 0 then
   Response.write(FormatNumber(((nuevesp_0 / 207))*100, 2))
else
   var1 = 0
   response.write "0"
end if
...
rst.open "select count(codcli) as valor from mt_alumno WITH (NOLOCK) where ano_mat=2018 and estacad='VIGENTE' and periodo_mat = 1 and ano <2018",Conn
if rst.recordcount > 0 then
   Response.write(FormatNumber(((anttot_0 / 1252))*100, 2))
else
   var1 = 0
   response.write "0"
end if
...
%>
        % </font></div></td>
    <td width="50"><div align="center"><font size="2" color="#0033FF" face="Verdana, Arial, Helvetica, sans-serif">1.252</font></div></td>
...
rst.open "select count(codcli) as valor from mt_alumno WITH (NOLOCK) where ano_mat=2018 and estacad='VIGENTE' and periodo_mat = 1 and ano <2018",Conn
if rst.recordcount > 0 then
   Response.write(FormatNumber(((antdiurnos_0 / 522))*100, 2))
else
   var1 = 0
   response.write "0"
end if
...
%>
        % </font><font color="#000000"></font></div></td>
    <td width="50"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">522</font></div></td>
...
rst.open "select count(codcli) as valor from mt_alumno WITH (NOLOCK) where ano_mat=2018 and estacad='VIGENTE' and periodo_mat = 1 and ano <2018",Conn
if rst.recordcount > 0 then
   Response.write(FormatNumber(((antvesp_0 / 730))*100, 2))
else
   var1 = 0
   response.write "0"
end if
...
%>
        % </font><font color="#000000"></font></div></td>
    <td width="50"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">730</font></div></td>
...
%>
    ...
    <td><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">1.669</font></div></td>
