...
<table border="0">
  ...
  <tr> 
    <td><strong></strong></td>
    <td width="60"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">2012</font></div></td>
    <td><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">2011</font></div></td>
    <td><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">2010</font></div></td>
    <td><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">2009</font></div></td>
...
%>
        % </font></div></td>
    <td width="50"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">456</font></div></td>
...
%>
        % </font><font color="#000000"></font></div></td>
    <td width="50"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">946</font></div></td>
...
rst.open "select count(codcli) as valor from mt_alumno WITH (NOLOCK) where ano_mat=2012 and estacad='VIGENTE' and periodo_mat = 1 and ano =2012",Conn
if rst.recordcount > 0 then
   Response.write(FormatNumber(((anttot_0 / (946+456)))*100, 2))
else
   var1 = 0
   response.write "0"
end if
...
rst.open "select count(codcli) as valor from mt_alumno WITH (NOLOCK) where ano_mat=2012 and estacad='VIGENTE' and periodo_mat = 1 and ano =2012",Conn
if rst.recordcount > 0 then
   Response.write(FormatNumber(((antdiurnos_0 / (219+292)))*100, 2))
else
   var1 = 0
   response.write "0"
end if
...
%>
        % </font><font color="#000000"></font></div></td>
    <td width="50"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">694</font></div></td>
