...
rst.open "select count(codcli) as valor from mt_alumno WITH (NOLOCK) where ano_mat=2017 and estacad='VIGENTE' and periodo_mat = 1 and fec_mat=CONVERT(VARCHAR(11), GETDATE())",Conn
if rst.recordcount > 0 then
   response.write rst("valor")
else
   response.write "0"
...
<table border="0">
  ...
  <tr>
    <td><strong></strong></td>
    <td width="60"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">2017</font></div></td>
    <td><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">2016</font></div></td>
    <td><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">2015</font></div></td>
    <td><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">2014</font></div></td>
...
rst.open "select count(codcli) as valor from mt_alumno WITH (NOLOCK) where ano_mat=2017 and estacad='VIGENTE' and periodo_mat = 1",Conn
if rst.recordcount > 0 then
