...
RamosSolici.Open strRamosSolici, Conn
dim paso 
paso=0
...
<head> 
<title>IPVC - Resultado de Inscripcion de Asignaturas</title>
<meta http-equiv="Content-Type" content="text/html;">
<!-- Fireworks 4.0  Dreamweaver 4.0 target.  Created Wed Nov 06 17:26:22 GMT-0300 2002--></head> 
...
<div align="left"> 
  <form name="form1" method="post" action="asignatura-seccion.asp">
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="left" width="697">
      ...
      <tr valign="top"> 
	   <td colspan="2"><img name="fder_r1_c1" src="imag/f-der/f-der_r1_c1.gif" width="336" height="19" border="0"></td>
        <td width="344"><img name="fder_r1_c2" src="imag/f-der/f-der_r1_c2.gif" width="248" height="19" border="0"></td>
      </tr>
      <tr> 
        <td colspan="2"><img name="fder_r2_c1" src="imag/f-der/resumen.gif" width="336" height="28" border="0"></td>
        <td width="344"><img src="imag/f-der/no-ayuda.gif" width="248" height="28"></td>
      </tr>
      <tr valign="bottom"> 
      ...
      <tr valign="bottom"> 
        <td width="202"><b><font face="Geneva, Arial, Helvetica, san-serif" size="1">Fecha:<%=date()%></font></b></td>
        <td width="151"><b><font face="Geneva, Arial, Helvetica, san-serif" size="1">Hora 
          :<%=time()%> </font></b></td>
        <td width="344"> 
          <div align="right"></div>
        </td>
      ...
      <tr valign="top"> 
        <td colspan="3" height="80"> 
          <table width="664" cellspacing="0" cellpadding="0" height="59" border="1" bordercolor="#FFFFFF">
            ...
            <tr bgcolor="4a5da1"> 
			  ...
			  <td height="16" width="73"> 
                <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b><font size="1">Tipo</font></b></font></div>
              </td>
            </tr>
            <% 
		  ...
		  Else
		   ...
		   %>
            <tr bgcolor="ffc172" height="25"> 
              <td width="46" height="8" align="center"><font face="Verdana" size="1"><%=RamosDebe("CodRamo")%></font></td>
              <td width="255" height="0" align="center"><font face="Verdana" size="1"><%=RamosDebe("Nombre")%></font></td>
              <td width="61" height="0" align="center"><font face="Verdana" size="1"><%=CodSecc%></font></td>
              <td width="83" height="16" align="center"><font size="1" face="Arial, Helvetica, sans-serif"><%=Horario%></font></td>
              <td width="132" height="16" align="center"><font size="1" face="Arial, Helvetica, sans-serif"><%=RamosDebe("NombreReal")%></font></td>
			  <td width="73" height="16" align="center"><font size="1" face="Arial, Helvetica, sans-serif"><%if RamosDebe("Tipocurso")="T"  then
		 ...
		 End If %>
          ...
          <br>
          <table width="661" cellspacing="0" cellpadding="0" height="59" border="1" bordercolor="#FFFFFF">
            <td height="17" colspan="6"> 
              <div align="left"> 
                <p><font face="Verdana, Arial, Helvetica, sans-serif" size="1" color="#000000">Ud. 
            ...
            <tr bgcolor="ffc172" height="25"> 
              ...
              <td width="109" height="16" align="center"><font size="1" face="Arial, Helvetica, sans-serif"><%=RamosSolici("NombreReal")%></font></td>
			   <%  if paso=1 then %> 
				    ...
				    <td width="123" height="16" align="center"><font size="1" face="Arial, Helvetica, sans-serif"><%if Ucase(RamosSolici("Estado")) = "A" then
