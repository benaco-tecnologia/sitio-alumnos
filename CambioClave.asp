...
<%
Dim CambioClave, RequerirMixClave
...
if EstaHabilitadaNW (471)="S" then 
	if GetPermisoNW(471) ="N" then
		...
		strParame="SELECT dbo.Fn_ValorParame('RequerirMixClave')Parame"
		set rstParame= Session("Conn").Execute(strParame)		
		if not rstParame.eof then
				RequerirMixClave=rstParame("Parame")
			else
				RequerirMixClave="" 
		end if
...
Audita 471,"Ingresa a cambio de clave"
