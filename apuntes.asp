...
<table width="100%" border='1' cellpadding='5' cellspacing='0' > 
  <tr>
    <td class="caption" background="Imagenes/fdo-cabecera-cel22.jpg" height="30"><span class="normalname"><a style='text-align:center; cursor:hand; cursor:pointer; text-decoration:none;' onclick="expandit('<%=Rs1("ANO")%>');">Documentos PublicaDescarga A&ntilde;o <%=Rs1("ANO")%></a></span></td>
  </tr>
  <tr>
    <td valign='top' style='display:none ;' id='<%=Rs1("ANO")%>'><table width="100%" border='1' cellpadding='0' cellspacing='0'>
        <tr>
          <td width='5%' align='center' valign='top' bgcolor="#DBECF2"><span class="normalname"><a style='text-align:center; cursor:hand; cursor:pointer; text-decoration:none;' onclick="expandit('<%=Rs1("ANO") & "_I" %>');">I Semestre</a></span></td>
		...
		While Not Rs5.Eof%>
                                        <tr>
                                          ...
                                          <td width='4%' align="center" valign="top">
											  <% if Rs5("IdArchivo1")<>"" then%><a href='doctos/<%=Rs5("CodigoRamo")%>/<%=Rs5("CodProfeFolder")%>/<%=Rs5("AnoPublicacion")%>/S1/<%=Rs5("IdArchivo1")%>'><img src='addon/imagenes/Descarga.jpg' width='20' height='20' border='none'></a><br><%end if%>
											  <% if Rs5("IdArchivo2")<>"" then%><a href='doctos/<%=Rs5("CodigoRamo")%>/<%=Rs5("CodProfeFolder")%>/<%=Rs5("AnoPublicacion")%>/S1/<%=Rs5("IdArchivo2")%>'><img src='addon/imagenes/Descarga.jpg' width='20' height='20' border='none'></a><br>
											  <%end if%>
											  <% if Rs5("IdArchivo3")<>"" then%><a href='doctos/<%=Rs5("CodigoRamo")%>/<%=Rs5("CodProfeFolder")%>/<%=Rs5("AnoPublicacion")%>/S1/<%=Rs5("IdArchivo3")%>'><img src='addon/imagenes/Descarga.jpg' width='20' height='20' border='none'></a><br>
											  <%end if%>											  											  
										  </td>
                                        </tr>
                                        <%
...
End if%>
        ...
        <tr>
          <td width='5%' align='center' valign='top' bgcolor="#DBECF2"><span class="normalname"><a style='text-align:center; cursor:hand; cursor:pointer; text-decoration:none;' onclick="expandit('<%=Rs1("ANO") & "_II" %>');">II Semestre</a></span></td>
          <td width='95%' valign='top'><span class="normalname">
            <%
TablaRamos=""
TablaProfesores=""
	...
	then
		...
		While Not Rs5.Eof%>
                                        <tr>
                                          ...
                                          <td width='89%' align="left" valign="middle"><span class="normalname"><%=Rs5("DetalleDocumento")%>&nbsp;</span></td>
                                          <td width='4%' align="center" valign="top">
										  	  <% if Rs5("IdArchivo1")<>"" then%><a href='doctos/<%=Rs5("CodigoRamo")%>/<%=Rs5("CodProfeFolder")%>/<%=Rs5("AnoPublicacion")%>/S2/<%=Rs5("IdArchivo1")%>'><img src='addon/imagenes/Descarga.jpg' width='20' height='20' border='none'></a><br>
										  	  <%end if%>
											  <% if Rs5("IdArchivo2")<>"" then%><a href='doctos/<%=Rs5("CodigoRamo")%>/<%=Rs5("CodProfeFolder")%>/<%=Rs5("AnoPublicacion")%>/S2/<%=Rs5("IdArchivo2")%>'><img src='addon/imagenes/Descarga.jpg' width='20' height='20' border='none'></a><br>
											  <%end if%>
										  <% if Rs5("IdArchivo3")<>"" then%><a href='doctos/<%=Rs5("CodigoRamo")%>/<%=Rs5("CodProfeFolder")%>/<%=Rs5("AnoPublicacion")%>/S2/<%=Rs5("IdArchivo3")%>'><img src='addon/imagenes/Descarga.jpg' width='20' height='20' border='none'></a><br>
										  <%end if%>	</td>
                                        </tr>
                                        <%
			Rs5.MoveNext
