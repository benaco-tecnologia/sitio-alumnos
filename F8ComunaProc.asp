...
<script>
function filtra(){
	TheForm.action="F8ComunaProc.asp"
	TheForm.submit();
}
function consulta(Comuna)
{ window.opener.document.TheForm.txtcomunapro.value=Comuna;
   window.close();
}
</script>
...
<form name="TheForm" method="post" action="">
  <table width="530" border="0">
    ...
    <tr class="titulo"> 
      <td colspan="3">Consulta de <span class="titulo">Comuna Procedencia</span></td>
    </tr>
    <tr class="titulo">
