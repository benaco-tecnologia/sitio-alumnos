...
%>
<%
RutaDoctos = Server.MapPath("/") & "/Alumnosnet/"
...
'	RAMOS_POR_SECCION=""
'end if
RAMOS_POR_SECCION = MaterialSeccion
...
%>
                      <table width='100%' border='1' cellpadding='3' cellspacing='0' class='smalltext'>
                        <tr> 
                          ...
                          <%if ConterProfesRamos2(Rs2("CODRAMO"), 1,"")>0 then response.Write("<img src='addon/imagenes/btn_show-all_bg.gif' width='16' height='16'>") end if%>&nbsp;&nbsp;<%=Rs2("CODRAMO")%>: <%=Rs3("NOMBRE")%></a></span></td>
                        </tr>
                        <tr >
			...
			Set Rs3 = session("conn").Execute("SELECT NOMBRE from ra_ramo where codramo='" & Rs2("CODRAMO") & "'")%>
                      ...
                      <table width='100%' border='1' cellpadding='3' cellspacing='0' class='smalltext'>
                        <tr>
                          ...
                          <td bgcolor='#FFFFCC'><span class="normalname"><a style='text-align:left; cursor:hand; cursor:pointer; text-decoration:none;' onClick="expandit('<%=Rs2("ANO") & "_" & Rs2("PERIODO") & "_" & Rs2("CODRAMO")%>');"><%if ConterProfesRamos2(Rs2("CODRAMO"), 2,"")>0 then response.Write("<img src='addon/imagenes/btn_show-all_bg.gif' width='16' height='16'>") end if%>&nbsp;&nbsp;(<%=Rs2("CODRAMO")%>):<%=Rs3("NOMBRE")%></a>
                          </span></td>
                        </tr>
                        <tr>
                          <td valign='top' style='display:none ;' id='<%=Rs2("ANO") & "_" & Rs2("PERIODO") & "_" & Rs2("CODRAMO")%>'>
...
if RAMOS_POR_SECCION = "SI" then
archivo1 = "Doctos" +"/"+ Rs5("CODRAMO") + "/" + Rs5("CODPROF") + "/" + Rs5("CODPROFEFOLDER") + "/" + Rs5("FECHAUPLOAD") + "/" + Rs5("PERIODOPUBLICACION") + "/" + Cstr(Rs5("CODSECC")) + "/" + Rs5("IdArchivo1")

archivo2 = "Doctos" +"/"+ Rs5("CODRAMO") + "/" + Rs5("CODPROF") + "/" + Rs5("CODPROFEFOLDER") + "/" + Rs5("FECHAUPLOAD") + "/" + Rs5("PERIODOPUBLICACION") + "/" + Cstr(Rs5("CODSECC")) + "/" + Rs5("IdArchivo2")

archivo3 = "Doctos" +"/"+ Rs5("CODRAMO") + "/" + Rs5("CODPROF") + "/" + Rs5("CODPROFEFOLDER") + "/" + Rs5("FECHAUPLOAD") + "/" + Rs5("PERIODOPUBLICACION") + "/" + Cstr(Rs5("CODSECC")) + "/" + Rs5("IdArchivo3")
end if

if not isnull(Rs5("tipodocumento")) then
 
archivo1 = "Doctos" +"/"+ Rs5("CODRAMO") + "/" + Rs5("CODPROFEFOLDER") + "/" + Rs5("ANOPUBLICACION") + "/S2" +  Rs5("IdArchivo1")

archivo2 = "Doctos" +"/"+ Rs5("CODRAMO") + "/" + Rs5("CODPROFEFOLDER") + "/" + Rs5("ANOPUBLICACION") + "/S2" +  Rs5("IdArchivo2")

archivo3 = "Doctos" +"/"+ Rs5("CODRAMO") + "/" + Rs5("CODPROFEFOLDER") + "/" + Rs5("ANOPUBLICACION") + "/S2" +  Rs5("IdArchivo3")
...
%>
                                  ...
                                  <td width='11%' align='center' valign='middle'><span class="normalname"><%=Day(cDate(Rs5("FECHA_FIN"))) & "/" & Month(cDate(Rs5("FECHA_FIN"))) & "/" & year(cDate(Rs5("FECHA_FIN")))%></span></td>
                              	  ...
                              	  <%if Rs5("IdArchivo1")<>"" or Rs5("IdArchivo1")<>null then%>
                                  <%if ExisteArchivo(RutaDoctos & archivo1) = true then%>
                                      <td width='4%' align="center" valign="top"><div title="descargar material">
                                      <a href='<%=archivo1%>'><img src='addon/imagenes/IconoDescarga[1].gif' width='25' height='25' border='none'></a></div>
                                      </td>
                                  <%end if%>
                                  ...
                                  <%if Rs5("IdArchivo2")<>"" or Rs5("IdArchivo2")<>null then%>  
                                  <%if ExisteArchivo(RutaDoctos & archivo2) = true then%>
                                      <td width='4%' align="center" valign="top"><div title="descargar material">
                                      <a href='<%=archivo2%>'><img src='addon/imagenes/IconoDescarga[1].gif' width='25' height='25' border='none'></a></div>
                                      </td>
                                  <%end if%>
                                  ...
                                  <%if Rs5("IdArchivo3")<>"" or Rs5("IdArchivo3")<>null then%>
                                  <%if ExisteArchivo(RutaDoctos & archivo3) = true then%>
                                      <td width='4%' align="center" valign="top"><div title="descargar material">
                                      <a href='<%=archivo3%>'><img src='addon/imagenes/IconoDescarga[1].gif' width='25' height='25' border='none'></a></div>
                                      </td>
                                  <%end if%> 
...
function ConterProfesRamos2(CodigoRamo, Periodo, Codprof)
'response.Write(CodigoRamo + Periodo)
'response.End()
	str="Select Count(*) as Conter from ca_doctos where codramo='" & CodigoRamo & "' And PeriodoPublicacion='" & Periodo & "' And Activo='1' AND COALESCE(EVALUADO,'NO')='SI'"
	if codprof <> "" then
		str = str & " and codprof ='"& Codprof &"'" 
	end if
    
	Set rs = Session("Conn").Execute(str) 
	ConterProfesRamos2 = rs("Conter")
end function
