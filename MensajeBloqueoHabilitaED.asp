				  ...
				  <table width="92%" border="0" cellspacing="15">
					...
					<tr> 
					  <td><p><font face="Verdana, Arial, Helvetica, sans-serif"><font color="#CC3333" size="2"> 
						  La evaluaci&oacute;n docente se llevar&aacute; a cabo en un periodo 
						  posterior a la toma de ramos. Puedes inscribir tus asignaturas sin evaluar.</font></font></p></td>
					</tr>
					<tr> 
					  <td>&nbsp;</td>
					</tr>
