		...
		<table width="200" border="0" cellpadding="0" cellspacing="0" align="center">
		  <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="20" height="550" bgcolor="#FFFFFF">
			  <tr> 
				<td valign="top"><font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="#4a5da1"><b>A&uacute;n no se apertura el proceso o ha 
terminado el periodo de inscripci&oacute;n de asignaturas.</b></font> 
		        <p>&nbsp;</p></td>
			  </tr>
			</table>
			</td>
