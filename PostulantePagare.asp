...
<body>
	<div id="container">
		...
		str="INSERT INTO ra_Documentos_web( codcli ,documento ,ANO ,PERIODO ,fecha ,estado,tipo)VALUES('"& session("RutPostul") &"','PAGARE',"& ano &","& periodo &",GETDATE(),'EN PROCESO','POSTULANTE') "
        ...
        <table width="650" border="0" cellpadding="0" cellspacing="0" >
            <tr valign="top" >
                <td width="425" height="100">
                    <h1>Documento Pagar&eacute;.</h1> 
                    <br /><a href="Documentos/<%=session("RutPostul")& rst("codigo")%>.pdf" style="font-size:18px">Descargar Pagar&eacute;<a></td>                <td width="159"><img src="imagenes/2_r1_c2.jpg" height="130" width="150"></td>
            </tr>           
        </table>			
        <br />
        <br />
