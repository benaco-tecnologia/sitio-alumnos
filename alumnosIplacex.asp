...
<body >
<div id="popup">
    <a target="_blank" href="http://t.sidekickopen68.com/e1t/c/5/f18dQhb0S7lC8dDMPbW2n0x6l2B9nMJW7t5XZs1p1hXdN5v_N3MRYt3jVQJSG056dSBQf5dRQM402?t=http%3A%2F%2Fwww.iplacex.cl%2Freclamos&si=5408091828387840&pi=c7e348a7-fd9e-4ee4-b2d8-1530a27fe296" > 
       <img src="imagenes/iplacex/botonrojo.png" width="300" height="66" hspace="631" vspace="416" border="0" usemap="#Map"/> 
    </a> 
 </div>
 <div id="popup2">
    <a target="_blank" href="mailto:portalalumnos@iplacex.cl" > 
       <img src="imagenes/iplacex/botonamarillo.png" width="300" height="66" hspace="267" vspace="416" border="0" usemap="#Map"/> 
    </a> 
 </div>
		...
		<table width="200" border="0" cellpadding="0" cellspacing="0">
		  <tr>
			<td width="0" valign="top" align="left" >			
                <table width='198' height='136' border='0' cellpadding='0' cellspacing='0' aling ='right'>
                <tr valing = 'top'>
                <td valign='top'><img name='A_r1_c1' src='imagenes/iplacex/2_r1_c1.jpg' width='18'height='136' border='0' alt=''></td>
                <td valign='top' ><img name='A_r1_c2' src='imagenes/2_r1_c2.jpg' width='162' height='136' border='0' alt=''></td>
                <td valign='top'><img name='A_r1_c3' src='imagenes/iplacex/2_r1_c3.jpg' width='18' height='136' border='0' alt=''></td>
                </tr>
                </table>
		    ...
		    <td valign="top" align="left" >
				...
				<table width='704' height='0' border='0' cellpadding='0' cellspacing='0'>
                <td valign='top'><img name='A_r1_c4' src='imagenes/iplacex/A_r1_c4.jpg' width='826' height='80' border='0' alt=''></td>
                </table>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="702">
                  <tr> 
                    <td width="702" colspan="5" valign="top"><img name="_r3_c4" src="Imagenes/iplacex/A-_r3_c4.jpg" width="826" height="480" border="0"></td>
                  </tr>
                </table>
            </td>
		  </tr>
                ...
                <table width="198" border="0" cellspacing="0" cellpadding="0" height="559">
                    <tr valign="top">
                        <td width="18" height="449">
                            <img src="imagenes/iplacex/-_r4_c1.jpg" name="_r4_c1" width="18" height="276" border="0">
                        </td>
                        <td width="162" height="449">
                            <table width="162" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td background="imagenes/iplacex/-_r10_c2.jpg" valign="bottom" height="139">
                                ...
                                <tr>
                                    <td valign="top">
                                        <img name="_r12_c2" src="imagenes/iplacex/-_r12_c2.jpg" width="162" height="23" border="0">
                                    </td>
                                </tr>
                                <!--<tr><td align="center">
                    <a href="#" id="needone" onClick="return RecuperaClave();">Recuperar clave</a></td>
                        ...
                        <td height="449" width="18" valign="top">
                            <img name="_r4_c3" src="imagenes/iplacex/-_r4_c3.jpg" width="18" height="277" border="0">
                        </td>
                    </tr>
                </table>
            </td>
...
strParame="SELECT dbo.Fn_ValorParame('ACTIVALIBRESITE')Parame,dbo.Fn_ValorParame('SERVICIOLIBRESITE')SERVICIOLIBRESITE,dbo.Fn_ValorParame('URLLIBRESITE')URLLIBRESITE"
set rstParame= Session("Conn").Execute(strParame)
    ...
    <table width="198" border="0" cellspacing="0" cellpadding="0" height="559" align="right">
        ...
        <td width="162" height="559" valign="top">
            <table width="162" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <a target="_top" href="javascript:Enviar3('<%=enlaces(9)%>','<%=TomadeRamo(session("Codcarr"),session("Codcli"),session("ano_ed"),session("periodo_ed"))%>','<%=BLOQUEAPAENCUESTAS%>');"
                            onmouseout="MM_swapImgRestore();" onmouseover="MM_swapImage('A_r8_c2','','imagenes/botones/cdn2.jpg',1);">
                            <img name="A_r8_c2" src="imagenes/botones/cdn1.jpg" width="162" height="27" border="0"
                                alt="">
                    </td>
                </tr>
                <tr>
                ...
                <td align="center">
                    <a href="javascript:Enviar3('<%="javascript:enviarlibresitio()"%>','<%=TomadeRamo(session("Codcarr"),session("Codcli"),session("ano_ed"),session("periodo_ed"))%>','<%=BLOQUEAPAENCUESTAS%>');">
                        <img alt="LibreSite" id="LibreSite" src="imagenes/botones/A-Biblio-of.jpg" onMouseOver="MM_swapImage('LibreSite','','imagenes/botones/A-Biblio-on.jpg',1)"
                            onmouseout="MM_swapImgRestore()" width="162" border="0" /></a>
                </td>
                </tr>
                <tr>
                    <td height="10">
