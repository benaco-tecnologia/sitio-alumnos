...
<body onload="" link="#717274" vlink="#717274" alink="#717274">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFCC00">
                    ...
                    <tr>
                        <td height="46" colspan="2" background="img/top-gris.gif" class="titulo_blanco_bold">
                            Operaci&oacute;n Finalizada, Antencedentes del Pago:
                        </td>
                    </tr>
                    <tr>
    ...
    <center>
      <p><br />
        ...
        <br />
        <b class="Tit-celdas style2"><font face="Verdana, Arial, Helvetica, sans-serif">Para consultar su nuevo estado de Pago dir&iacute;jase al<br />
