						...
						<td colspan="3" height="80"> 
						  <table width="960" cellspacing="1" cellpadding="0" height="59" border="0" bordercolor="#FFFFFF">
							<td height="20" colspan="11"> <div align="left"> 
								<p class="text-normal-celdas"><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000" id="lblAsigInscritas">Ud. 
							...
							<tr background="imagenes/fdo-cabecera-cel22.jpg"> 
							  ...
							  <td width="77" height="30" background="imagenes/fdo-cabecera-cel22.jpg"> <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b><font size="1" name="lblColumnaRamo">Asignatura Malla</font></b></font></div></td>
                              ...
                              <td width="80" height="30" background="imagenes/fdo-cabecera-cel22.jpg" NOWRAP> <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b><font size="1" id="lblColumnaSala">Sala</font></b></font></div></td>
							  <td width="67" height="30" background="imagenes/fdo-cabecera-cel22.jpg"> <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b><font size="1" name="lblColumnaRamoDictado">Asignatura Dictada</font></b></font></div></td>
							  ...
							  <td width="148" height="30" background="imagenes/fdo-cabecera-cel22.jpg"><div align="center"><strong><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif" id="lblColumnaProfesor">Nombre Profesor </font></strong></div></td>
                         ...
                         <%end if %>
						  ...
						  <table width="960" cellspacing="1" cellpadding="0" height="59" border="0" bordercolor="#FFFFFF">
							<td height="17" colspan="6"> 
							  <div align="left"> 
								<p class="text-normal-celdas"><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000" id="lblAsigSolicita">Ud. 
							...
							<tr background="Imagenes/fdo-cabecera-cel22.jpg"> 
							  ...
							  <td width="166" height="30" background="imagenes/fdo-cabecera-cel22.jpg"> 
								<div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b><font size="1" name="lblColumnaRamo">Asignatura Malla</font></b></font></div>							  </td>
							  ...
							  <td width="110" height="30" background="imagenes/fdo-cabecera-cel22.jpg"> 
								<div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"><b><font size="1" name="lblColumnaRamoDictado">Asignatura Dictada</font></b></font></div>							  </td>
...
strParame="SELECT COALESCE(dbo.Fn_ValorParame('MUESTRAHORARIOSEMANALPORTAL'),'NO')Parame"
if BCL_ADO(strParame, rstParame) then
  HORARIOSEMANAL=trim(rstParame("Parame"))
end if

if HORARIOSEMANAL = "SI" then
	Movimiento = request("s")
	
	if session("FechaHorario") = "" or Movimiento = "" then
		session("FechaHorario") = Day(Date) &"-"& Month(Date) &"-"& Year(Date) 
	end if 
	
	if Movimiento = "1" then
	  session("FechaHorario") = cdate(session("FechaHorario"))+ 7
	end if 
	...
	strHs= "SP_TRAE_FECHA_SEMANA '"& session("FechaHorario") &"'"
	
	if bcl_ado(strHs,rstHs) then
	  FechaHorario = rstHs("FechaHorario")
	  FechaHorarioIni = rstHs("FechaHorarioIni")
	  FechaHorarioFin = rstHs("FechaHorarioFin")
	  SemanaHorario = rstHs("SemanaHorario")
	  
	  session("FechaHorario") = FechaHorario
	end if
else
	session("FechaHorario") = Day(Date) &"-"& Month(Date) &"-"& Year(Date) 
end if
session("FechaHorario") = replace(session("FechaHorario"),"/","-")

strHorario = "SP_MUESTRA_HORARIO_ALUMNO '"& CodCli &"','" & ano & "','" & periodo & "','"& session("FechaHorario") &"' "
set RstHorario = Session("Conn").execute(strHorario)
...
%>
        ...
        <td height="1" colspan="2" class="Tit-celdas"><b><font size="2" face="Verdana, Arial, Helvetica, sans-serif" id="lblHorario">Horario 
      ...
      <tr valign="top" >
        ...
        <table width="960" cellspacing="1" cellpadding="0" height="72" border="0" bordercolor="#FFFFFF" >
          ...
          <!--Mejora Semana induccion -->  
          <% 
		  if HORARIOSEMANAL = "SI" then
          %>
          <tr valign="top" > 
            <td height="1" colspan="2" class="Tit-celdas">&nbsp;
                    
            </td> 
            <td height="1" colspan="5" class="Tit-celdas">&nbsp;
          ...
          <tr valign="top" > 
          	 <td width="50" height="30" align="center" colspan="2" class="Tit-celdas">
             	<A href="resultado.asp?s=0"><IMG src="imagenes/flecha-izq.jpg" border="0"  name="Image7"></A>
             </td>
             <td width="50" height="30" align="center" colspan="6" class="Tit-celdas">
             <font size="3" face="Verdana, Arial, Helvetica, sans-serif">Fecha de horario: <%=FechaHorarioIni &" al "& FechaHorarioFin%></font>
             </td>
             <td width="50" height="30" align="center" colspan="1" class="Tit-celdas">
             	<A href="resultado.asp?s=1"><IMG src="imagenes/flecha-der.jpg" border="0"  name="Image7"></A>
             </td>
          </tr>
          
          <tr valign="top" > 
          	 <td width="50" height="30" align="left" colspan="3" class="Tit-celdas">
             	<font size="2" face="Verdana, Arial, Helvetica, sans-serif">
                	<a href="resultado.asp?s=0" >Semana Anterior</a>
                </font>
             </td>
             <td width="50" height="30" align="right" colspan="3" class="Tit-celdas">
             	<font size="3" face="Verdana, Arial, Helvetica, sans-serif">Semana: <%=SemanaHorario%> 
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </font>
             </td>
             <td width="50" height="30" align="right" colspan="3" class="Tit-celdas">
             	<font size="2" face="Verdana, Arial, Helvetica, sans-serif">
                	<a href="resultado.asp?s=1" >Semana Siguiente</a>
                </font>
             </td>
          </tr>
          <%end if%>  
             ...
             <% 
					...
					if MtrHorSt(i,j) ="E" then
					   ...
					   DiaNoTope = MtrHorarioDia(i, j) 
						...
						strNoTope = "SELECT DISTINCT TOP 1 h.codramo+'/'+CONVERT(VARCHAR,h.codsecc)+'-'+h.codsal Ramo,h.FECHA,ramo.nombre nombreramo"
						strNoTope = strNoTope &" FROM RA_RESERVASALA h,ra_nota c ,ra_ramo ramo "
						...
						strNoTope = strNoTope &" AND h.codramo= ramo.codramo "
						...
						MtrHorSt(i,j)="I"
						if not RstNoTope.eof then
							do while not RstNoTope.eof
								 RamoFinal = RamoFinal & RstNoTope("Ramo") & "<br>"
								 Ramo = RstNoTope("NombreRamo")
								 MtrHorSt(i,j)="E"
								 RstNoTope.movenext
							loop
							
						MtrNombreRamo(i, j) = ucase(Ramo & ", tope de horario con asignatura: " & MtrNombreRamo(i, j))
