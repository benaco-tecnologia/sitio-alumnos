...
<%
	...
	If (Request.Form("certificado") = "0" or Request.Form("fin") = "0" or Request.Form("institucion") = "" or Request.Form("correoelectronico") = "") Then
		Session("error_datos") = "verdadero"
		url = "./solicitud.asp?err=true&usrcod=" & Request.Form("rut")
	...
	If Not estacad(Session("rut")) And Not excepcionCertificado(Session("rut")) Then 
		Response.Redirect("./wrn_201099.html")
	End If
	
	If Not estfinan(Session("rut")) And Not excepcionCertificado(Session("rut")) Then
	...
	StrSql = "select a.rut, c.dig, c.nombre + ' ' + c.paterno + ' ' + c.materno as nombre, a.codcli as numero_ecas, ano_mat as anio, c.sexo as sexo from mt_alumno a, mt_client c where a.rut = c.codcli and c.codcli = '" + Session("rut") + "';"
	rs.Open strSql,Conn
	sexo = ""
...
<form name="frmConfirmacion" action="./grabar.asp" method="post"> 
    <div class="certificado">
        ...
        <img name="" src="http://www.ecasvirtual.cl/images/header-1.jpg" style="width: 200px;" />
		</div>
