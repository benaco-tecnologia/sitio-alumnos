		  ...
		  <tr>
			...
			<% CargarTop1()%><% SubMenu()%>
				  ...
				  <form name="form1" method="post" action="">
					...
					<tr> 
					  <td><p class="parrafo"><font color="#CC3333" size="2" face="Verdana, Arial, Helvetica, sans-serif">Usted no tiene un correo electrónico asociado a su cuenta, Comuníquese con la unidad académica para actualizar sus datos.</font></p></td>
					</tr>
					<tr> 
					  <td>&nbsp;</td>
					</tr>
