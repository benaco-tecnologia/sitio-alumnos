...
<%if Instr(Request.ServerVariables("HTTP_REFERER"), "resultadopruebas.asp") <> 0 then %>
	<script>
...
if HORARIOSEMANAL = "SI" then
	...
	if session("FechaHorario") = "" or Movimiento = "" then
		session("FechaHorario") = "01-03-2017"'Date'Day(Date) &"-"& Month(Date) &"-"& Year(Date) 
	end if 
        ...
        <table width="960" cellspacing="1" cellpadding="0" height="72" border="0" bordercolor="#FFFFFF" >
          ...
          <tr valign="top" > 
          	 <td width="50" height="30" align="center" colspan="2" class="Tit-celdas">
             	<A href="resultadopruebas.asp?s=0"><IMG src="imagenes/flecha-izq.jpg" border="0"  name="Image7"></A>
             </td>
             ...
             <td width="50" height="30" align="center" colspan="1" class="Tit-celdas">
             	<A href="resultadopruebas.asp?s=1"><IMG src="imagenes/flecha-der.jpg" border="0"  name="Image7"></A>
             </td>
          </tr>
          ...
          <tr valign="top" > 
          	 <td width="50" height="30" align="left" colspan="3" class="Tit-celdas">
             	<font size="2" face="Verdana, Arial, Helvetica, sans-serif">
                	<a href="resultadopruebas.asp?s=0" >Semana Anterior</a>
                </font>
             </td>
             ...
             <td width="50" height="30" align="right" colspan="3" class="Tit-celdas">
             	<font size="2" face="Verdana, Arial, Helvetica, sans-serif">
                	<a href="resultadopruebas.asp?s=1" >Semana Siguiente</a>
                </font>
             </td>
          </tr>
          <%end if%>  
