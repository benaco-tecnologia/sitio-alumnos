...
<body>
	<div id="container">
		...
		str="INSERT INTO ra_Documentos_web( codcli ,documento ,ANO ,PERIODO ,fecha ,estado,tipo)VALUES('"& session("RutPostul") &"','CUPONMATRICULA',"& ano &","& periodo &",GETDATE(),'EN PROCESO','POSTULANTE') "
        ...
        <table width="650" border="0" cellpadding="0" cellspacing="0" >
            <tr valign="top" >
                <td width="425" height="100">
                    <h1>Cup&oacute;n de Matr&iacute;cula</h1>                    
                    <br /><a href="Documentos/<%=session("RutPostul")& rst("codigo")%>.pdf" style="font-size:18px">Descargar Cup&oacute;n de Matr&iacute;cula<a></td>                
