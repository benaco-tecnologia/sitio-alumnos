                ...
                <td align='left' valign='top' background='addon/imagenes/filete_v.png' bgcolor='#C4CBD2'><table width='100%'  border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                      <td><table width="100%" border="0" cellpadding="3" cellspacing="5">
                          <tr>
                            <td width="23"><img src="addon/imagenes/logo_box_titulo.gif" width="23" height="11"></td>
                            <td width="1177" class="normalname"><%=boxNoticia_MsgTitulo %></td>
                          </tr>
                      </table></td>
                    </tr>
                  </table>
        ...
        <tr>
          <td><table cellpadding='0' cellspacing='0' bgcolor='#C4CBD2' style='width:100%'>
              <tr>
                ...
                <td width='100%' bgcolor='#ffffff'><TABLE width=100% border=0 align=center cellPadding=0 cellSpacing=0 bgcolor='#C4CBD2'>
                    <TBODY>
                      <TR>
                        <TD align="left" valign="top" bordercolor='#CC0000' bgcolor='#E2E6EA'><span class="normalname"><!--#include file="noticias.asp" --></span></TD>
                      </TR>
                    </TBODY>
                </TABLE></td>
