...
Class FreeASPUpload
	...
	Public Sub Save(path)
		...
		For Each fileItem In UploadedFiles.Items
			...
			' Si el archivo exite, lo borramos para simular un reemplazo
			set fso = createobject("scripting.filesystemobject")
			if fso.FileExists (path & fileItem.FileName) then 
				Response.Write "Archivo '"& path & fileItem.FileName&"' existe! (reemplazado)<br />"
				fso.DeleteFile path & fileItem.FileName, true
				set fso = nothing
			end if
