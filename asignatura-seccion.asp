...
<script languaje="javascript">
		...
		function validaSubseccion()
		{
			/*opciones = document.getElementsByName("opciones");
			for(var i=0; i<opciones.length; i++) { 
			
			opciones[i].cheked = false;
			}*/			
			window.location="validaSubseccion.asp";
			//return false;
		}
--></script>
			  ...
			  if CantidadRamos > 1 then
					...
					%>
						...
						<%
						 ...
						 %>
							...
							<td> 
							  <div align="right">
							  <a href="javascript:validaSubseccion();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','Imagenes/botones/continuar-on.gif',1)"><img src="Imagenes/botones/continuar-of.gif" width="178" height="45" name="Image1" border="0"></a></div>							</td>
							</tr>
					 <%  
						   end if
			else
				%>
						<td height="21"> 
						  <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b><font size="1"><!--a href="javascript:;" onMouseOver="MM_openBrWindow('tex-seccionhorario.htm','seccionhorario','width=500,height=500')"><img src="imag/botones/instrucciones.gif" width="122" height="23" border="0"></a--></font></b></font></p>						</td>
						<td> 
						  <div align="right"><a href="javascript:validaSubseccion();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','Imagenes/botones/continuar-on.gif',1)"><img   src="Imagenes/botones/continuar-of.gif" width="178" height="45" name="Image1" border="0"></a>						  </div>						</td>
					</tr>
				  <%          
			end if  
			%>
						...
						<td width="72" height="16"> <div align="center">
							<p><font face="Verdana" size="1"> 
							  ...
							  <% if EstaPreInscrito(Codcli, RamosSelec(i), ArrayRamos(0, posRamos), ArrayRamos(1, posRamos), Ano, Periodo, TipoCurso) then %>
									...
									<input type="radio" id="<%=ArrayRamos(0, posRamos)%>" name="<%=RamosSelec(iP)%>" value="false" OnClick="javascript:GrabaSel(this,'<%=RamosSelec(i)%>', '<%=ArrayRamos(0, posRamos)%>', '<%=ArrayRamos(1, posRamos)%>',<%=i%>,'<%=mid(TextoTipoCurso ,1,1)%>','<%=ArrayRamos(9, posRamos)%>');javascript:marca(this, '<%=trim(ArrayRamos(0, posRamos))%>')" CHECKED <%If ((Inscritos >= Cupos) or (cursado)) and Not PuedeBotar then Response.Write("DISABLED") End if%> >
							  <% else %>
